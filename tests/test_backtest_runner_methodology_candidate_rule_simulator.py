...
def test_generate_reports_exports_candidate_rule_simulation(
    tmp_path,
    capsys,
) -> None:
    ...
    csv_path = tmp_path / "methodology_candidate_rule_simulation.csv"
    json_path = tmp_path / "methodology_candidate_rule_simulation.json"
...
def test_candidate_rule_outputs_are_additive(tmp_path, capsys) -> None:
    runner = _runner(tmp_path)
