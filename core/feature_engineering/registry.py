...
class FeatureRegistry:
    ...
    # Bootstrap definitions registered on construction.
    # Order matches the original registration order.
    _BOOTSTRAP_DEFINITIONS: tuple[FeatureDefinition, ...] = (
        FeatureDefinition(
    ...
    def __init__(self) -> None:
        ...
        for definition in self._BOOTSTRAP_DEFINITIONS:
