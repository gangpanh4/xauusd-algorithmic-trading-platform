...
class BacktestResult:
    ...
    average_trade_quality: float = 0.0
    
    average_trade_quality_confidence: float = 0.0
    
    excellent_quality_trades: int = 0
    
    high_quality_trades: int = 0
    
    medium_quality_trades: int = 0
    
    low_quality_trades: int = 0
    
    rejected_quality_trades: int = 0